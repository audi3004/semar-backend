...
const approvedDaysSchema = Joi.number().integer().positive().allow(null).optional().messages({
    "number.base": "Jumlah hari disetujui harus berupa angka",
    "number.integer": "Jumlah hari disetujui harus berupa bilangan bulat",
    "number.positive": "Jumlah hari disetujui harus lebih besar dari 0",
});
...
const create = Joi.object({
    ...
    jumlah_hari_disetujui: approvedDaysSchema,
    ...signatureSchemas,
})
    .custom(
        (
