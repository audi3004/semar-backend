...
const Spkl = sequelize.define("Spkl", {
    ...
    id_kategori_lembur: { type: DataTypes.INTEGER, allowNull: true, references: { model: "m_kategori_lembur", key: "id_kategori_lembur" } },
    id_jenis_pekerjaan_lembur: { type: DataTypes.INTEGER, allowNull: true, references: { model: "m_jenis_pekerjaan_lembur", key: "id_jenis_pekerjaan_lembur" } },
    kategori_lembur: { type: DataTypes.STRING(1000), allowNull: false },
    jenis_pekerjaan: { type: DataTypes.STRING(1000), allowNull: true },
